...
%% if size in ['f', 'h']
	...
	\needspace{\ht0}
	\begin{center}
%% if 'fill_to_bottom' in im.format_options
	% image dimensions as large as possible
	\begin{overpic}[height=\measurepage,width=\linewidth,keepaspectratio]{\VAR{im.path_o+im.out_file_name}}\VAR{caption1(im.latex_description, 0.7)}
%% else
