...
%% if size == 'f' or size == 'h'
	...
	\needspace{\ht0}
	\begin{center}
	\begin{overpic}[width=0.9\linewidth]{\VAR{im.path_o+im.outFileName}}\VAR{caption1(im.latex_description)}
	\end{overpic}
	\end{center}
	%% if size == 'f'
	\raggedcolumns
	...
	%% endif
%% elif size == 'p'
	\includepdf[picturecommand*={\VAR{caption2(im.latex_description)}}]{\VAR{im.path_o+im.outFileName}}
%% elif size == 's'
	\cleartoleftpage
	\includepdf[pages=-, picturecommand*={\VAR{caption2(im.latex_description)}}]{\VAR{im.path_o+im.outFileName}}
%% endif
%% endif
%% endmacro
%#
