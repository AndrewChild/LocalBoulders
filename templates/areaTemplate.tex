...
%% for map in subArea.subAreaMaps.values()
%% if map.size == 'f'
\fullPic{../maps/subarea/\VAR{map.outFileName}}{\VAR{map.description}}
%% else
\halfPic{../maps/subarea/\VAR{map.outFileName}}{\VAR{map.description}}
%% endif
%% endfor
%% if subArea.name
...
\halfPic{./Image/\VAR{photo.fileName}}{\VAR{photo.description}}
%% endfor

%% if subArea.boulders
%% for boulder in subArea.boulders.values()
%% for topo in boulder.topos.values()
%% if topo.size == 'f'
\fullPic{../maps/topos/\VAR{topo.outFileName}}{\VAR{topo.description}}
%% else
\halfPic{../maps/topos/\VAR{topo.outFileName}}{\VAR{topo.description}}
%% endif
%% endfor
